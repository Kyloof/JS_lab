...
class SimpleReporter:
    def analyze(self, series):
        mean = sum(series.measurements) / len(series.measurements)

        return [f"Info: {series.measure_name} at {series.station_code} has mean = {mean}"]
...
if __name__ == "__main__":
    ...
    analysis_objects = [simple_reporter, outlier_detector, zero_spike_detector, threshold_detector]
